...
public class GameViewWindow {
    ...
    public void imgui() {
        ...
        MouseListener.setGameViewportPos(new Vector2f(windowPos.x + ImGui.getCursorScreenPosX() + 5,
                windowPos.y + ImGui.getCursorScreenPosY() - 5));
    ...
    private ImVec2 getLargestSizeForViewPort() {
        ...
        // return new ImVec2(aspectWidth + ImGui.getCursorPosX(), aspectHeight +
        // ImGui.getCursorPosY());
    ...
    private ImVec2 getCenteredPositionForViewPort(ImVec2 aspectSize) {
        ...
        // System.out.println("CursrPos: " + ImGui.getCursorPosX() + ", " +
        // ImGui.getCursorPosY());
        // System.out.println("CurScrPos:" + ImGui.getCursorScreenPosX() + ", " +
